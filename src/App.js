...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Board field={size === 0 ? [] : superDone && showSolution >= 0 ? solutions[showSolution] : stack[stack.length - 1]} width={20} handleSubmit={handleStart} size={size} pieces={countPieces(ps)} />
